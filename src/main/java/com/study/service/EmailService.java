...
public class EmailService {
   ...
   public MimeMessage createMessage(String to,String ePw) throws MessagingException, UnsupportedEncodingException {
      ...
      message.setSubject("HeadlthGroup 이메일 인증 코드 발급"); // 메일 제목

      // 메일 내용 메일의 subtype을 html로 지정하여 html문법 사용 가능
      String msg = "";
      msg += "<div><h1 style=\"font-size: 30px; padding-right: 30px; padding-left: 30px;\">헬스그룹 회원가입 인증 코드입니다 </h1>";

      msg += "<span style=\"font-size:24px; font-weight:bold;\">인증 번호 :" + ePw + "</span>";
      msg += "</div>";
      message.setText(msg, "utf-8", "html"); // 내용, charset타입, subtype
      message.setFrom(new InternetAddress(id, "HealthGroup")); // 보내는 사람의 메일 주소, 보내는 사람 이름 //***설정해놔서
                                                               // 메일 주소를 id로 바꿀 수 있는 것같은데.,,?
      return message;
   }
